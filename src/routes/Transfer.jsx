  ...
  return (
    <>
      <div className='relative w-full h-full flex flex-col justify-center items-center'>
        <div className='border-none md:shadow-custom-transfer lg:shadow-custom-transfer p-10 md:p-14 lg:p-14 w-full md:w-[34rem] lg:w-[40rem] overflow-y-auto flex flex-col'>
          <h2 className='text-4xl md:text-5xl lg:text-5xl font-bold pt-[5.9rem] md:pt-0 lg:pt-0 pb-5 self-start'>Transfer</h2>
